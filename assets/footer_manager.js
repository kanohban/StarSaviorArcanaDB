const FooterManager = {
    init(container) {
        ...
        const footerHTML = `
            <div class="app-footer-content" style="text-align: center; padding: 2rem 1rem; color: #888; font-size: 0.9rem; line-height: 1.6;">
                <p style="margin: 0;">이 페이지는 게임 '스타 세이비어'의 비영리 팬 프로젝트입니다.</p>
                <p style="margin: 0;">프로젝트에 사용된 모든 자산, 데이터, 이미지 및 텍스트의 소유권은 STUDIOBSIDE 에 있습니다.</p>
                <p style="margin: 0;">© STUDIOBSIDE Co. Ltd All Rights Reserved.</p>
